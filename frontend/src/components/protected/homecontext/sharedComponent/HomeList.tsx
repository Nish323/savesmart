...
export function HomeList({ transactions, showDate = false }: HomeListProps) {
      ...
      {transactions.length > 0 ? (
        <div className="space-y-4">
          {transactions.map((transaction, index) => (
            <div
              key={index}
              className="flex flex-col lg:flex-row lg:items-center justify-between p-3 bg-gray-50 rounded-lg gap-2"
            >
              {/*アイコンと金額*/}
